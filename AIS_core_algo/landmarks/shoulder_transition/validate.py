...
from .._validate_utils import bilateral, check, contour_distance
...
def validate(
    ...
    issues: list[dict] = []
    st: dict = bilateral(gt, "shoulder_transition")
    nr: dict = bilateral(gt, "neck_root")
    ax: dict = bilateral(gt, "axilla")
