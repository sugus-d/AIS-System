...
from .._validate_utils import bilateral, check, load_curvature_at_point, z_top_percent
...
def validate(
    ...
    """
    issues: list[dict] = []
    sp = bilateral(gt, "scapular_peaks")
    nr = bilateral(gt, "neck_root")
    ax = bilateral(gt, "axilla")
